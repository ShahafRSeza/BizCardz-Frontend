      ...
      <div className="container">
        ...
        >
          <h1 className="text-center">
            <span>Edit {card.name}'s Card</span>
          </h1>
          <button className="btn btn-outline h-50" onClick={() => navigate(-1)}>
            cancel
          </button>
        </div>
      </div>
      <div className="container cardForm">
        ...
        >
          ...
          <div className="d-flex gap-3">
            <button type="submit" className="btn btn-warning w-50 registerBtn">
              Edit BizCard
            </button>
            <div
              className="btn btn-outline-danger w-50 d-flex align-items-center justify-content-center"
